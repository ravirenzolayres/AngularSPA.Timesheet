...
@Component({
  selector: 'app-bio-logs-view',
  templateUrl: './bio-logs-view.component.html',
  styleUrls: ['./bio-logs-view.component.css']
})
export class BioLogsViewComponent implements OnInit {
  dtOptions: any = {};
